...
def generate_launch_description():
    ...
    pkg_offload_server_node = get_package_share_directory('offload_server')
    ...
    localization_params_arg = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_offload_agent_gz_bringup, 'config', 'localization.yaml']),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution(
                    [pkg_offload_agent_gz_bringup, 'launch', 'offload_localization_launch.py'])),
