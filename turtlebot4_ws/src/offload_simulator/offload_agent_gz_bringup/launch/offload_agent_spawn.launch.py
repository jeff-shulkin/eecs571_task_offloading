...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('model', default_value='standard',
                          ...
                          description='Offload Agent Model'),
...
def generate_launch_description():
    ...
    # Paths
    offload_agent_ros_gz_bridge_launch = PathJoinSubstitution(
        [pkg_offload_agent_gz_bringup, 'launch', 'ros_gz_bridge.launch.py'])
    ...
    robot_name = GetNamespacedName(namespace, 'offload_agent')
    ...
    spawn_robot_group_action = GroupAction([
        ...
        # ROS IGN bridge
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([offload_agent_ros_gz_bridge_launch]),
            launch_arguments=[
